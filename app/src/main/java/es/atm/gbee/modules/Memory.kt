...
object Memory {
    ...
    val bootstrapRom = byteArrayOf(
        ...
        0x0E.toByte(), 0x13.toByte(),                   // LDH [0xFF00 + 0x13], A
        0x24.toByte(),                                  // INC H
        0x7C.toByte(),                                  // LD A, H
        ...
        0xFE.toByte(), 0x64.toByte(), 0x20.toByte(), 0x06.toByte(),
        0x7B.toByte(), 0xE2.toByte(), 0x0C.toByte(), 0x3E.toByte(), 0x87.toByte(), 0xF0.toByte(), 0x42.toByte(), 0x90.toByte(),
        0xE0.toByte(), 0x42.toByte(), 0x15.toByte(), 0x20.toByte(), 0xD2.toByte(), 0x05.toByte(), 0x20.toByte(), 0x4F.toByte(),
        0x16.toByte(), 0x20.toByte(), 0x18.toByte(), 0xCB.toByte(), 0x4F.toByte(), 0x06.toByte(), 0x04.toByte(), 0xC5.toByte(),
        0xCB.toByte(), 0x11.toByte(), 0x17.toByte(), 0xC1.toByte(), 0xCB.toByte(), 0x11.toByte(), 0x17.toByte(), 0x05.toByte(),
        0x20.toByte(), 0xF5.toByte(), 0x22.toByte(), 0x23.toByte(), 0x22.toByte(), 0x23.toByte(), 0xC9.toByte(), 0xCE.toByte(),
        0xED.toByte(), 0x66.toByte(), 0x66.toByte(), 0xCC.toByte(), 0x0D.toByte(), 0x00.toByte(), 0x0B.toByte(), 0x03.toByte(),
        0x73.toByte(), 0x00.toByte(), 0x83.toByte(), 0x00.toByte(), 0x0C.toByte(), 0x00.toByte(), 0x0D.toByte(), 0x00.toByte(),
        0x08.toByte(), 0x11.toByte(), 0x1F.toByte(), 0x88.toByte(), 0x89.toByte(), 0x00.toByte(), 0x0E.toByte(), 0xDC.toByte(),
        0xCC.toByte(), 0x6E.toByte(), 0xE6.toByte(), 0xDD.toByte(), 0xDD.toByte(), 0xD9.toByte(), 0x99.toByte(), 0xBB.toByte(),
        0xBB.toByte(), 0x67.toByte(), 0x63.toByte(), 0x6E.toByte(), 0x0E.toByte(), 0xEC.toByte(), 0xCC.toByte(), 0xDD.toByte(),
        0xDC.toByte(), 0x99.toByte(), 0x9F.toByte(), 0xBB.toByte(), 0xB9.toByte(), 0x33.toByte(), 0x3E.toByte(), 0x3C.toByte(),
        0x42.toByte(), 0xB9.toByte(), 0xA5.toByte(), 0xB9.toByte(), 0xA5.toByte(), 0x42.toByte(), 0x3C.toByte(), 0x21.toByte(),
        0x04.toByte(), 0x01.toByte(), 0x11.toByte(), 0xA8.toByte(), 0x00.toByte(), 0x1A.toByte(), 0x13.toByte(), 0xBE.toByte(),
        0x20.toByte(), 0xFE.toByte(), 0x23.toByte(), 0x7D.toByte(), 0xFE.toByte(), 0x34.toByte(), 0x20.toByte(), 0xF5.toByte(),
        0x06.toByte(), 0x19.toByte(), 0x78.toByte(), 0x86.toByte(), 0x23.toByte(), 0x05.toByte(), 0x20.toByte(), 0xFB.toByte(),
        0x86.toByte(), 0x20.toByte(), 0xFE.toByte(), 0x3E.toByte(), 0x01.toByte(), 0xE0.toByte(), 0x50.toByte())
