...
\paragraph{Número de Banco ROM: 0x2000–0x3FFF}
Este registro tiene en cuenta los 5 primeros bits del valor que se escriba, es decir, los valores que se tienen en cuenta están en el rango 0x01-0x1F.
\\\\
Si se intenta escribir el valor 0x00, la CPU lo tratará como un 0x01 ya que el \hyperref[par:rom0bank]{banco fijo de ROM} no puede estar duplicado.
\\\\
En el caso de que se indique un número mayor al de bancos disponibles en el cartucho, el banco seleccionado como resultado será el último. Por ejemplo, en un cartucho de 256KiB, el bit número 5 quedaría enmascarado, ya que el solamente necesita 4 bits para seleccionar uno de sus 16 posibles bancos.
