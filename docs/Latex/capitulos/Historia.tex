...
\begin{figure}[H]
    ...
    \caption{Modos internos de la PPU}
...
\begin{figure}[H]
    ...
    \caption{Obtención de colores para un tile}
...
\begin{figure}[H]
    ...
    \caption{Capa de fondo de la PPU}
...
\paragraph{0xFF4A - 0xFF4B: WY, WX}

Especifican el offset de la ventana respecto de la esquina superior izquierda. Los valores que pueden tomar están dentro de los siguientes rangos: 0-166 para WX y 0-143 para WY. Mencionado previamente, WX tiene un offset de 7 pixeles. 
\\\\
