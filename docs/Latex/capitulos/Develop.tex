...
Para implementar las acciones de leer o escribir en ROM, hay que tener en cuenta cómo cada \hyperref[history_mbcs]{MBC} gestiona de manera particular las regiones de memoria y cuáles son sus registros.
\\\\
